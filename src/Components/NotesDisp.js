...
<p>Enter a word to describe your previous week:</p>
   ...
   <div style={{display:'flex'}} className="custom_tracking">
   <div style={{width:"40%"}} className="tracking_img">
   <img  src='/images/goals.png'/>
   </div>
   <div style={{width:"50%"}} className='notes_disp_section'>
